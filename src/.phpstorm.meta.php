...
'task.index','task.create','task.edit','task.show','task.store',
'task.update','task.toggle-complete','task.destroy','sanctum.csrf-cookie','events.index','events.store','events.show','events.update',
'events.destroy','events.attendees.index','events.attendees.store','events.attendees.show','events.attendees.destroy','books.index','books.show','books.reviews.create',
'books.reviews.store','storage.local',);
        registerArgumentsSet('views', 
'books.index','books.reviews.create','books.show','components.star-rating','form.task',
'layout.main','task.create','task.edit','task.index','task.show',
